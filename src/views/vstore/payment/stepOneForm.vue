<template>
  <v-container fluid mt-0  class="my-0 py-0">
    <v-layout row wrap>
      ...
      <v-flex xs6>
        <v-text-field
          :color="currentBussinesClub.theme.secondary"
          hide-details
          :label="$t('message.identification')"
        ></v-text-field>
      </v-flex>
      <v-flex xs6>
        <v-text-field
          :color="currentBussinesClub.theme.secondary"
          hide-details
          :label="$t('message.telephoneNumber')"
        ></v-text-field>
      </v-flex>
      <v-flex xs12>
        <v-text-field
      ...
      <v-flex xs12>
        <v-text-field
          :color="currentBussinesClub.theme.secondary"
          hide-details
          :label="$t('message.address')+' 2'"
        ></v-text-field>
      </v-flex>
      <v-flex xs12>
        <v-checkbox
        :color="currentBussinesClub.theme.primary"
          :label="$t('message.saveAddressToMyAccount')"
        ></v-checkbox>
      </v-flex>
    </v-layout>
  </v-container>
